...
return (
    <>
        ...
        dark:hidden'>
            <Image src={assets.header_bg_color} alt='hd-bg' className='w-full' />
        </div>
        ...
        >
            ...
            <ul className={`hidden md:flex items-center gap-6 lg:gap-8 rounded-full px-12 py-3 
                    ...
                    ${isScroll 
                        ? 'opacity-100' 
                        : 'bg-white shadow-sm bg-opacity-50 dark:bg-gray-800/50 opacity-100'
                    }
                `}
            >
            ...
            <div className='flex items-center gap-4'>
                ...
                <a href="#contact" className='hidden lg:flex items-center gap-3 px-10 py-2.5 
                                border border-gray-400 dark:border-white/50 
